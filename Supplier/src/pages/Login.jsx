...
export default function Login() {
  ...
  return (
    <div className='flex flex-col ml-28 items-center justify-center h-screen bg-gradient-to-r from-slate-900 to-blue-500'>
      <h1 className='text-4xl font-bold mb-4 text-white'>Supplier Login</h1>
      <form onSubmit={handleSubmit} className='bg-white mt-6 p-8 rounded-lg shadow-lg'>
        <input
          type='text'
      ...
      <div className='flex mt-8 text-lg text-white'>
        ...
        <Link to='/register' className=' ml-4 underline text-lg font-bold'>
          Register
        </Link>
      </div>
