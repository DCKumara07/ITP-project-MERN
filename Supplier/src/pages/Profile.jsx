  ...
  return (
    ...
    <div className='p-3 max-w-lg mx-auto '>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 '>
        <img src="https://img.icons8.com/ios/50/000000/user" alt="User" className="supplier-image h-20 w-20 rounded-full p-2 bg-gray-300 mx-auto" />
        ...
        <Link className='bg-blue-900 text-white p-3 rounded-lg  hover:opacity-85 disabled:opacity-80 text-center mx-auto' to={"/createsitems"}> Create Supplier Items</Link>
      ...
      {supplierSitems && supplierSitems.length > 0 && <div className='flex flex-col gap-4'>
        ...
        <input
          ...
          className="border border-gray-400 py-2 px-4 rounded-md mx-auto"
        />
        <button onClick={handleSearch} className="text-white uppercase bg-blue-500 px-2 rounded-md mx-auto">
          Search By Name
        </button>
